...
Update your +application.html.erb+ (choose one of these based on whether or not you're using Turbolinks):
...
Alternatively, you can import Leña separately which may impact performance, but it will catch compiler errors in any scripts included after it:
