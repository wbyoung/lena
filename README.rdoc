= Leña {<img src="https://badge.fury.io/rb/lena.png" alt="Gem Version" />}[http://badge.fury.io/rb/lena] {<img src="https://secure.travis-ci.org/wbyoung/lena.png"/>}[http://travis-ci.org/wbyoung/lena] {<img src="https://codeclimate.com/github/wbyoung/lena.png"/>}[https://codeclimate.com/github/wbyoung/lena] {<img src="https://coveralls.io/repos/wbyoung/lena/badge.png"/>}[https://coveralls.io/r/wbyoung/lena]
...
Add +lena+ to your +Gemfile+, then <tt>bundle install</tt>:
